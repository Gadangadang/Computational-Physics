...
int main(int argc, char const *argv[]) {
  ...
  //Earth moon
  object moon(moon_mass,9.650680140386343e-01,2.490935556612275e-01 ,2.255009344807005e-05,-4.947244172663867e-03*365,1.680676694174045e-02*365,4.784486394167822e-05*365);
  //Jupiter
