...
int main(int argc, char const *argv[]) {
  ...
  binary_verlet.add(planet1); binary_verlet.add(planet2); binary_verlet.add(planet3);binary_verlet.add(planet4);binary_verlet.add(planet5);binary_verlet.add(sun);
